...
#        self.ui.buttonLoad.clicked.connect(self.underConstruction)
        ...
        self.ui.pid_type_list.clicked.connect(self.pid_list_selection_clicked)
        
        self._accro_pid_tuning_panel = AccroPIDTuningController(vehicle_event_dispatcher, ui_event_dispatcher)
        self.ui.panel_container.addWidget(self._accro_pid_tuning_panel)
        self.ui.panel_container.setCurrentIndex(0)
        
        self._accro_pid_controller = AccroPIDTuningController(vehicle_event_dispatcher,ui_event_dispatcher)
        self.ui.panel_container.addWidget(self._accro_pid_controller)
        self.ui.panel_container.setCurrentWidget(self._accro_pid_controller)
        
    def pid_list_selection_clicked(self):
        print self.ui.pid_type_list.currentItem().text()
